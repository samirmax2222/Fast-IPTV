...
var require_package = __commonJS({
  "package.json"(exports, module) {
    module.exports = {
      name: "fastiptv",
      version: "0.15.8",
      description: "Fast IPTV player application.",
      homepage: "https://chromewebstore.google.com/detail/dbdgibnjfnomhihldbjcdbgddamjmboi",
      author: {
        name: "allen",
        email: "softroyals@gmail.com"
      },
      keywords: [
        "angular",
        "electron",
      ...
      scripts: {
        ...
        "build:web": "npm run build -- -c web && cp src/*.js dist/ && cp manifest.json dist/manifest.json && sed -i '' '/base href/d' dist/index.html && rm -rf dist/3rdpartylicenses.txt && zip -r dist.zip dist/",
...
// node_modules/.pnpm/@angular+animations@18.2.1_@angular+core@18.2.1/node_modules/@angular/animations/fesm2022/browser.mjs
var LINE_START = "\n - ";
...
// node_modules/.pnpm/@angular+platform-browser@18.2.1_@angular+animations@18.2.1_@angular+common@18.2.1_@angular+core@18.2.1/node_modules/@angular/platform-browser/fesm2022/animations.mjs
...
// node_modules/.pnpm/@angular+service-worker@18.2.1_@angular+common@18.2.1_@angular+core@18.2.1/node_modules/@angular/service-worker/fesm2022/service-worker.mjs
...
// node_modules/.pnpm/@ngrx+effects@18.0.2_@angular+core@18.2.1_@ngrx+store@18.0.2_rxjs@7.8.1/node_modules/@ngrx/effects/fesm2022/ngrx-effects.mjs
...
// node_modules/.pnpm/@ngrx+store-devtools@18.0.2_@ngrx+store@18.0.2_rxjs@7.8.1/node_modules/@ngrx/store-devtools/fesm2022/ngrx-store-devtools.mjs
...
// node_modules/.pnpm/@ngx-translate+http-loader@8.0.0_@angular+common@18.2.1_@angular+core@18.2.1_@ngx-translate+core@15.0.0_rxjs@7.8.1/node_modules/@ngx-translate/http-loader/dist/fesm2022/ngx-translate-http-loader.mjs
...
var AppConfig = {
  ...
  BACKEND_URL: "https://fast-iptv.vercel.app"
};
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-ZNQQI7FK.js").then((c) => c.HomeComponent)
  },
  {
    path: "playlists",
    loadChildren: () => import("./chunk-NRIG2PZH.js").then((m) => m.PlayerModule)
  },
  {
    path: "iptv",
    loadChildren: () => import("./chunk-NRIG2PZH.js").then((m) => m.PlayerModule)
  ...
  {
    path: "settings",
    loadComponent: () => import("./chunk-YILCNKLZ.js").then((c) => c.SettingsComponent)
  },
  {
    path: "xtreams/:id",
    loadComponent: () => import("./chunk-DFCIIBVO.js").then((c) => c.XtreamMainContainerComponent)
  },
  {
    path: "portals/:id",
    loadComponent: () => import("./chunk-JPPGE7A7.js").then((c) => c.StalkerMainContainerComponent)
  },
  {
    path: "**",
    redirectTo: ""
...
var AppRoutingModule = class _AppRoutingModule {
  ...
  static {
    ...
    ], imports: [RouterModule.forRoot(routes, { useHash: true }), RouterModule] });
  }
};

// src/app/app.component.ts
var semver = __toESM(require_semver());
function AppComponent_ngx_whats_new_3_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "ngx-whats-new", 1);
    \u0275\u0275listener("closeModal", function AppComponent_ngx_whats_new_3_Template_ngx_whats_new_closeModal_0_listener() {
      \u0275\u0275restoreView(_r1);
...
var AppComponent = class _AppComponent {
  constructor(electronService, epgService, ngZone, playlistService, router, store, snackBar, translate, settingsService, whatsNewService) {
    ...
    this.DEFAULT_LANG = Language.ENGLISH;
    this.listeners = [];
    if ((this.electronService.isElectron && this.electronService?.remote?.process.platform === "linux" || this.electronService?.remote?.process.platform === "win32") && this.electronService.remote.process.argv.length > 2) {
      const filePath = this.electronService.remote.process.argv.find((filepath) => filepath.endsWith(".m3u") || filepath.endsWith(".m3u8"));
      if (filePath) {
  ...
  ngOnInit() {
    ...
    chrome?.runtime?.onMessage.addListener((message, sender, sendResponse) => {
      if (message.type === "install") {
        this.fetchSamplePlaylist().then((playlist) => {
          this.ngZone.run(() => {
        ...
        sendResponse({ response: "Sample playlist fetching initiated!" });
      }
    });
  }
  fetchSamplePlaylist() {
    ...
    return fetch(apiUrl).then((response) => {
      ...
      return fetch(sampleParseUrl).then((response) => {
        if (response.status === 200) {
          return response.json();
        }
        throw new Error(response.statusText);
  ...
  triggerAutoUpdateMechanism() {
    return __async(this, null, function* () {
      if (this.electronService.isElectron) {
        const playlistForAutoUpdate = yield firstValueFrom(this.playlistService.getPlaylistsForAutoUpdate());
        if (playlistForAutoUpdate && playlistForAutoUpdate.length > 0)
          this.electronService.sendIpcEvent(AUTO_UPDATE_PLAYLISTS, playlistForAutoUpdate);
      }
    });
  }
  /**
  ...
  setRendererListeners() {
    this.commandsList.forEach((command) => {
      if (this.electronService.isElectron) {
        this.electronService.listenOn(command.id, () => this.ngZone.run((data) => command.callback(data)));
      } else {
        const cb = (response) => {
  ...
  initSettings() {
    this.settingsService.getValueFromLocalStorage(STORE_KEY.Settings).subscribe((settings) => {
      if (settings && Object.keys(settings).length > 0) {
        ...
        if (settings.epgUrl?.length > 0 && settings.epgUrl?.some((u) => u !== "")) {
   ...
   */
  handleWhatsNewDialog() {
    const actualVersion = this.electronService.getAppVersion();
    this.settingsService.getValueFromLocalStorage(STORE_KEY.Version).subscribe((version) => {
      const isNewVersion = semver.gt(actualVersion, version || "0.0.0");
      if (!version || isNewVersion) {
        this.modals = this.whatsNewService.getModalsByVersion(actualVersion);
        this.setDialogVisibility(true);
      }
      this.settingsService.setValueToLocalStorage(STORE_KEY.Version, actualVersion);
    });
  }
  /**
   ...
   */
  showWhatsNewDialog() {
    this.modals = this.whatsNewService.getModalsByVersion(this.electronService.getAppVersion());
    this.setDialogVisibility(true);
  }
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AppComponent)(\u0275\u0275directiveInject(DataService), \u0275\u0275directiveInject(EpgService), \u0275\u0275directiveInject(NgZone), \u0275\u0275directiveInject(PlaylistsService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(Store), \u0275\u0275directiveInject(MatSnackBar), \u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(SettingsService), \u0275\u0275directiveInject(WhatsNewService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 6, vars: 3, consts: [[3, "items", "options", "closeModal", 4, "ngIf"], [3, "closeModal", "items", "options"]], template: function AppComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "router-outlet");
        \u0275\u0275text(1, "\n");
        \u0275\u0275text(2, "\n");
        \u0275\u0275template(3, AppComponent_ngx_whats_new_3_Template, 1, 2, "ngx-whats-new", 0);
        \u0275\u0275pipe(4, "async");
        \u0275\u0275text(5, "\n");
      }
      if (rf & 2) {
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", \u0275\u0275pipeBind1(4, 1, ctx.isDialogVisible$));
      }
    }, dependencies: [RouterOutlet, NgIf, NgxWhatsNewComponent, AsyncPipe], encapsulation: 2 });
  }
};
(() => {
...
var ElectronService = class _ElectronService extends DataService {
  /**
   ...
   */
  listenOn(command, callback) {
    this.ipcRenderer.on(command, callback);
  }
  static {
    this.\u0275fac = function ElectronService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ElectronService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ElectronService, factory: _ElectronService.\u0275fac, providedIn: "root" });
  }
};

// src/app/services/pwa.service.ts
var PwaService = class _PwaService extends DataService {
  constructor(http) {
    super();
    this.http = http;
    ...
    this.corsProxyUrl = AppConfig.BACKEND_URL;
    console.log("PWA service initialized...");
  }
  /** Uses service worker mechanism to check for available application updates */
  checkUpdates() {
    this.swUpdate.versionUpdates.subscribe(() => {
      this.snackBar.open(this.translateService.instant("UPDATE_AVAILABLE"), this.translateService.instant("REFRESH")).onAction().subscribe(() => {
  ...
  sendIpcEvent(type, payload) {
    if (type === PLAYLIST_PARSE_BY_URL) {
      ...
      this.forwardXtreamRequest(payload);
    } else if (type === STALKER_REQUEST) {
      this.forwardStalkerRequest(payload);
    }
  }
  refreshPlaylist(payload) {
    this.getPlaylistFromUrl(payload.url, payload.title).pipe(catchError((error) => {
      window.postMessage({
        type: ERROR
      });
      ...
      this.snackBar.open(this.translateService.instant("HOME.PLAYLISTS.PLAYLIST_UPDATE_SUCCESS"), null, { duration: 2e3 });
    });
  }
  /**
   ...
   */
  fetchFromUrl(payload) {
    this.getPlaylistFromUrl(payload.url).pipe(catchError((error) => {
      window.postMessage({
        type: ERROR,
      ...
      window.postMessage({
        ...
        payload: __spreadProps(__spreadValues({}, response), { isTemporary: payload.isTemporary })
      });
    });
  }
  getErrorMessageByStatusCode(status) {
    ...
    switch (status) {
      case 0:
        ...
        break;
      case 413:
        message = "This file is too big. Use standalone or self-hosted version of the app.";
        break;
      default:
        break;
    }
  ...
  forwardXtreamRequest(payload) {
    ...
    } : { headers: { "Ext-Id": chrome?.runtime?.id } };
  ...
  forwardStalkerRequest(payload) {
    const headers = { "Ext-Id": chrome?.runtime?.id };
  ...
  listenOn(_command, callback) {
    window.addEventListener("message", callback);
  }
  static {
    this.\u0275fac = function PwaService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PwaService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PwaService, factory: _PwaService.\u0275fac, providedIn: "root" });
  }
};

// src/app/state/effects.ts
var PlaylistEffects = class _PlaylistEffects {
  constructor(actions$, playlistsService, dataService, router, snackBar, storage, store, translate) {
    ...
    this.store = store;
    this.translate = translate;
    this.updateFavorites$ = createEffect(() => {
      return this.actions$.pipe(ofType(updateFavorites), combineLatestWith(this.store.select(selectFavorites), this.store.select(selectActivePlaylistId)), switchMap(([, favorites, playlistId]) => this.playlistsService.updateFavorites(playlistId, favorites)));
    }, { dispatch: false });
    this.setFavorites$ = createEffect(() => {
      return this.actions$.pipe(ofType(setFavorites), combineLatestWith(this.store.select(selectActivePlaylistId)), switchMap(([action, playlistId]) => this.playlistsService.setFavorites(playlistId, action.channelIds)));
    }, {
      dispatch: false
    });
    this.setActiveEpgProgram$ = createEffect(() => {
      return this.actions$.pipe(ofType(setActiveEpgProgram), combineLatestWith(this.store.select(selectActive)), map(([, activeChannel]) => {
        firstValueFrom(this.storage.get(STORE_KEY.Settings)).then((settings) => {
          if (settings && Object.keys(settings).length > 0 && settings.player === VideoPlayer.MPV)
            this.dataService.sendIpcEvent(OPEN_MPV_PLAYER, {
              url: activeChannel.url + (activeChannel.epgParams ?? "")
            });
          else if (settings && Object.keys(settings).length > 0 && settings.player === VideoPlayer.VLC)
    ...
    this.setActiveChannel$ = createEffect(() => {
      return this.actions$.pipe(ofType(setActiveChannel), combineLatestWith(this.store.select(selectIsEpgAvailable)), map(([action, isEpgAvailable]) => {
        ...
        firstValueFrom(this.storage.get(STORE_KEY.Settings)).then((settings) => {
          if (settings && Object.keys(settings).length > 0 && settings.player === VideoPlayer.MPV && channel.radio !== "true") {
            this.dataService.sendIpcEvent(OPEN_MPV_PLAYER, {
              url: channel.url
            });
          } else if (settings && Object.keys(settings).length > 0 && settings.player === VideoPlayer.VLC && channel.radio !== "true")
            this.dataService.sendIpcEvent(OPEN_VLC_PLAYER, {
              url: channel.url
            });
        });
        return setActiveChannelSuccess({
          channel: action.channel
        });
      }));
    });
    this.loadPlaylists$ = createEffect(() => {
      return this.actions$.pipe(ofType(loadPlaylists), switchMap(() => this.playlistsService.getAllPlaylists().pipe(map((playlists) => loadPlaylistsSuccess({
        playlists
      })))));
    });
    this.removePlaylist$ = createEffect(() => {
      return this.actions$.pipe(ofType(removePlaylist), switchMap((action) => this.playlistsService.deletePlaylist(action.playlistId)));
    }, { dispatch: false });
    this.updatePlaylist$ = createEffect(() => {
      return this.actions$.pipe(ofType(updatePlaylist), switchMap((action) => this.playlistsService.updatePlaylist(action.playlistId, __spreadProps(__spreadValues({}, action.playlist), {
        _id: action.playlistId
      }))));
    }, { dispatch: false });
    this.parsePlaylist$ = createEffect(() => {
      return this.actions$.pipe(ofType(parsePlaylist), map((action) => this.playlistsService.handlePlaylistParsing(action.uploadType, action.playlist, action.title, action.path)), map((playlist) => addPlaylist({
        playlist
      })));
    });
    this.addPlaylist$ = createEffect(() => {
      return this.actions$.pipe(ofType(addPlaylist), switchMap((action) => this.playlistsService.addPlaylist(action.playlist)), tap((playlist) => {
    ...
    this.updatePlaylistMeta$ = createEffect(() => {
      return this.actions$.pipe(ofType(updatePlaylistMeta), switchMap((action) => this.playlistsService.updatePlaylistMeta(action.playlist)));
    }, { dispatch: false });
    this.updatePlaylistPositions$ = createEffect(() => {
      return this.actions$.pipe(ofType(updatePlaylistPositions), switchMap((action) => this.playlistsService.updatePlaylistPositions(action.positionUpdates)));
    }, { dispatch: false });
    this.addManyPlaylists$ = createEffect(() => {
      return this.actions$.pipe(ofType(addManyPlaylists), switchMap((action) => this.playlistsService.addManyPlaylists(action.playlists)));
    }, { dispatch: false });
    this.updateManyPlaylists$ = createEffect(() => {
      return this.actions$.pipe(ofType(updateManyPlaylists), switchMap((action) => this.playlistsService.updateManyPlaylists(action.playlists)));
    }, { dispatch: false });
    this.removeAll$ = createEffect(() => {
      return this.actions$.pipe(ofType(removeAllPlaylists), switchMap(() => this.playlistsService.removeAll()), tap(() => {
        this.snackBar.open(this.translate.instant("SETTINGS.PLAYLISTS_REMOVED"), null, {
          duration: 2e3
        });
      }));
    }, { dispatch: false });
    this.setAdjacentChannelAsActive$ = createEffect(() => {
      return this.actions$.pipe(ofType(setAdjacentChannelAsActive), withLatestFrom(this.store.select(selectChannels), this.store.select(selectActive)), map(([action, channels, activeChannel]) => {
        let adjacentChannel;
        const index = channels.findIndex((channel) => channel.id === activeChannel.id);
  ...
  static {
    this.\u0275fac = function PlaylistEffects_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _PlaylistEffects)(\u0275\u0275inject(Actions), \u0275\u0275inject(PlaylistsService), \u0275\u0275inject(DataService), \u0275\u0275inject(Router), \u0275\u0275inject(MatSnackBar), \u0275\u0275inject(StorageMap), \u0275\u0275inject(Store), \u0275\u0275inject(TranslateService));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PlaylistEffects, factory: _PlaylistEffects.\u0275fac, providedIn: "any" });
  }
};
...
function DataFactory(dbService, http) {
  if (isElectron()) {
...
var AppModule = class _AppModule {
  ...
  static {
    this.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
      ...
      HttpClientModule,
      SharedModule,
      AppConfig.environment === "WEB" ? NgxIndexedDBModule.forRoot(dbConfig) : [],
