...
var EpgService = class _EpgService {
  constructor(store, electronService, snackBar, translate) {
    this.store = store;
  ...
  fetchEpg(urls) {
    ...
    urlsArray.forEach((url) => this.electronService.sendIpcEvent(EPG_FETCH, {
      url
    }));
    this.showFetchSnackbar();
  }
  showFetchSnackbar() {
    this.snackBar.open(this.translate.instant("EPG.FETCH_EPG"), this.translate.instant("CLOSE"), this.epgSnackBarOptions);
  }
  onEpgFetchDone() {
    this.store.dispatch(setEpgAvailableFlag({ value: true }));
    this.snackBar.open(this.translate.instant("EPG.DOWNLOAD_SUCCESS"), null, __spreadProps(__spreadValues({}, this.epgSnackBarOptions), {
      duration: 2e3
    }));
  }
  onEpgError() {
    this.snackBar.open(this.translate.instant("EPG.ERROR"), null, __spreadProps(__spreadValues({}, this.epgSnackBarOptions), {
      duration: 2e3
    }));
  }
  static {
    this.\u0275fac = function EpgService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _EpgService)(\u0275\u0275inject(Store), \u0275\u0275inject(DataService), \u0275\u0275inject(MatSnackBar), \u0275\u0275inject(TranslateService));
    };
  }
  static {
...
// src/app/settings/theme.enum.ts
var Theme;
(function(Theme2) {
  Theme2["DarkTheme"] = "DARK_THEME";
  Theme2["LightTheme"] = "LIGHT_THEME";
})(Theme || (Theme = {}));

// src/app/services/settings.service.ts
var PACKAGE_JSON_URL = "https://fastiptv.itoolkit.app/package.json";
var SettingsService = class _SettingsService {
   ...
   */
  setValueToLocalStorage(key, value, withCallback = false) {
    if (withCallback) {
   ...
   */
  getAppVersion() {
    return this.http.get(PACKAGE_JSON_URL).pipe(map((response) => response.version), catchError((err) => {
      console.error(err);
      throw new Error(err);
    }));
  }
  static {
    this.\u0275fac = function SettingsService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SettingsService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(StorageMap));
    };
  }
  static {
...
(function(Language2) {
  ...
  Language2["TRADITIONAL_CHINESE"] = "zhtw";
